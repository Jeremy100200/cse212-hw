...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        var normalizedWord1 = new string(word1.Where(c => !char.IsWhiteSpace(c)).ToArray()).ToLower();
        var normalizedWord2 = new string(word2.Where(c => !char.IsWhiteSpace(c)).ToArray()).ToLower();      
